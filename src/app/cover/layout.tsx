...
export const metadata: Metadata = {
  title: 'Cover — family travel insurance',
  description:
      ...
      <header className="border-b border-[color:var(--line)] bg-[color:var(--card)]/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-[19px] font-bold tracking-tight">Cover</span>
          ...
          <p className="hidden text-[12px] text-[color:var(--muted)] md:block">
            Underwritten by nobody — Cover is a fictional insurer in a Geena demo.
          </p>
        </div>
      </header>
      {children}
